...
When the user asks to connect an account, call `oauth_connect_card` and explain that the Agent App opens the mock OAuth flow. When the user asks whether the account is connected, call `oauth_status`.
